...
Then you need the hash_strings.txt file from [Light Converter from KillzXGaming (That tool crashes the game)](https://github.com/KillzXGaming/Paper-Mario-Tools/releases/tag/v1.2) , place it in the same folder as the .py and the .data, <br> 
